...
# Based on
[https://github.com/hypeserver/react-date-range](https://github.com/hypeserver/react-date-range)
...
retainStartDateOnSelection(DateRange) | Boolean   | false            | Retain start date when the end date is changed.
